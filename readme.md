...
And then modified by Mark Pruden to separate the handing of command from the main serial processing class
This allows multi level commands to be handled, since the command handler can have a command which invokes
another command handler, e.g. recursive.
